...
class Configuration(LibcxxConfiguration):
    ...
    def configure_src_root(self):
        ...
        self.libcxx_src_root = self.get_lit_conf("libcxx_src_root") or os.path.join(
            self.libunwind_src_root, "..", "libcxx"
        )
    ...
    def has_cpp_feature(self, feature, required_value):
        return int(self.cxx.dump_macros().get("__cpp_" + feature, 0)) >= required_value
    ...
    def configure_compile_flags_header_includes(self):
        ...
        libunwind_headers = self.get_lit_conf(
            "libunwind_headers", os.path.join(self.libunwind_src_root, "include")
        )
