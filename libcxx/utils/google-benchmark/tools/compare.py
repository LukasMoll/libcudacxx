...
def create_parser():
    ...
    utest.add_argument(
        ...
        type=float,
        help=(
            "significance level alpha. if the calculated p-value is below this value, then the result is said to be "
...
def main():
    ...
    output_lines = gbench.report.generate_difference_report(
        json1, json2, args.display_aggregates_only, args.utest, args.utest_alpha
    )
    print(description)
