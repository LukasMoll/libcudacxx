...
class GoogleBenchmark(TestFormat):
    ...
    def get_benchmark_tests(self, path, lit_config, local_config):
        ...
        try:
            output = subprocess.check_output(
                list_test_cmd, env=local_config.environment
            )
    ...
    def get_tests_in_directory(
        self, test_suite, path_in_suite, lit_config, local_config
    ):
        ...
        for subdir in self.test_sub_dirs:
            ...
            for fn in lit.util.listdir_files(dir_path, suffixes=self.test_suffixes):
                ...
                for testname in testnames:
                    ...
                    yield lit.Test.Test(
                        test_suite, test_path, local_config, file_path=execpath
                    )
